...
exports.addbilldetail = detail => {
    var sql = `INSERT INTO orderdetails(OrderID,ProID,Quantity,Price,Amount) VALUES('${detail.orderId}','${detail.proId}', '${detail.proName}'  , '${detail.quantity}', '${detail.price}','${detail.sum}')`;
    return db.save(sql);
}
