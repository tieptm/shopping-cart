...
exports.loadAll = () => {
    ...
    var sql = 'SELECT  FROM `orderdetails` INNER JOIN orders ON orderdetails.OrderID = orders.OrderID left JOIN products ON orderdetails.ProID = products.ProID WHERE orders.UserID = users.f_ID'
    return db.load(sql);
}
